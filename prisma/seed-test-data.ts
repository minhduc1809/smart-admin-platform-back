...
async function main() {
  ...
  const users = [
    ...
    {
      email: 'pgs.truong@ptit.edu.vn',
      username: 'truongphong_dt',
      role: Role.MANAGER,
      firstName: 'Trần Quốc',
      lastName: 'Trường',
    ...
    {
      email: 'ts.minh@ptit.edu.vn',
      username: 'truongphong_tcns',
      role: Role.MANAGER,
      firstName: 'Lê Hoàng',
      lastName: 'Minh',
      title: 'Trưởng phòng Tổ chức Nhân sự',
    },
    {
      email: 'ths.hoa@ptit.edu.vn',
      username: 'truongphong_khtc',
      role: Role.MANAGER,
      firstName: 'Phạm Thị',
      lastName: 'Hoa',
    ...
    {
      email: 'cv.linh@ptit.edu.vn',
      username: 'nhansu_linh',
      role: Role.HR,
      firstName: 'Vũ Thùy',
      lastName: 'Linh',
    ...
    {
      email: 'gv.duc@ptit.edu.vn',
      username: 'giangvien_duc',
      role: Role.USER,
      firstName: 'Hoàng Tiến',
      lastName: 'Đức',
      title: 'Giảng viên Khoa CNTT',
    },
    {
      email: 'gv.mai@ptit.edu.vn',
      username: 'giangvien_mai',
      role: Role.USER,
      firstName: 'Ngô Thanh',
      lastName: 'Mai',
      title: 'Giảng viên Khoa Viễn thông',
    },
    {
      email: 'cv.tuan@ptit.edu.vn',
      username: 'chuyenvien_tuan',
      role: Role.USER,
      firstName: 'Bùi Anh',
      lastName: 'Tuấn',
    ...
    {
      email: 'gv.an@ptit.edu.vn',
      username: 'giangvien_an',
      role: Role.USER,
      firstName: 'Đinh Quốc',
      lastName: 'An',
      title: 'Giảng viên Khoa QTKD',
    },
  ];
  ...
  for (const u of users) {
    const existing = await prisma.user.findFirst({
      where: { tenantId, OR: [{ email: u.email }, { username: u.username }] },
    });
    if (existing) {
    ...
    console.log(
      `  ${u.role.padEnd(7)} | ${u.email.padEnd(28)} | ${u.firstName} ${u.lastName} - ${u.title}`,
    );
  }
  ...
  const formDefs = [
    {
      ...
      description:
        'Cán bộ, giảng viên đăng ký nghỉ phép theo quy định của Học viện',
      schema: {
        formId: 'nghi-phep',
        fields: [
          {
    ...
    },
    {
      ...
      description:
        'Đề xuất mua sắm vật tư, thiết bị phục vụ giảng dạy và nghiên cứu',
      schema: {
        formId: 'mua-sam',
        fields: [
          {
    ...
    },
    {
      ...
      schema: {
        ...
        fields: [
          ...
          {
            key: 'tomTat',
            label: 'Tóm tắt nội dung nghiên cứu',
            type: 'text',
    ...
    },
    {
      ...
      description:
        'Đề xuất tổ chức hội thảo, workshop, sự kiện học thuật tại Học viện',
      schema: {
        ...
        fields: [
          ...
          {
            key: 'ngayToChuc',
            label: 'Ngày tổ chức dự kiến',
            type: 'date',
            rules: { required: true },
          },
          {
            key: 'soLuongThamGia',
            label: 'Số lượng tham gia dự kiến',
            type: 'number',
  ...
  const wfNghiPhep = {
    ...
    statesDetails: {
      cho_truong_phong: { slaHours: 24, timeoutAction: 'approve' },
      cho_nhan_su: { slaHours: 48 },
      cho_ban_giam_doc: { slaHours: 24 },
    },
  };
    ...
    transitions: [
      {
        from: 'cho_duyet',
        to: 'da_duyet',
        action: 'approve_truong_phong',
        roles: ['MANAGER', 'HR'],
        type: 'PARALLEL_JOIN',
        requireActions: ['approve_truong_phong', 'approve_tai_chinh'],
      },
      {
        from: 'cho_duyet',
        to: 'tu_choi',
  ...
  const wfNCKH = {
    ...
    transitions: [
      {
        from: 'nop_ho_so',
        to: 'hoi_dong_xet_duyet',
        action: 'start_review',
        roles: ['ADMIN', 'MANAGER'],
      },
      {
        from: 'hoi_dong_xet_duyet',
        to: 'da_duyet',
        action: 'vote_approve',
        roles: ['MANAGER'],
        type: 'VOTING',
  ...
  const wfCongTac = {
    ...
    statusMapping: { da_duyet: 'APPROVED', tu_choi: 'REJECTED' },
    statesDetails: {
      cho_truong_phong: { slaHours: 24 },
      cho_tai_chinh: { slaHours: 48 },
    },
  };
  ...
  const wfDefs = [
    ...
    {
      name: 'Quy trình duyệt mua sắm',
      formName: 'Đề xuất mua sắm thiết bị',
      config: wfMuaSam,
    },
    {
      name: 'Quy trình xét duyệt đề tài NCKH',
      formName: 'Đăng ký đề tài NCKH',
      config: wfNCKH,
    },
    {
      name: 'Quy trình duyệt sự kiện',
      formName: 'Đề xuất tổ chức sự kiện',
      config: wfSuKien,
    },
    {
      name: 'Quy trình duyệt công tác',
      formName: 'Đơn xin công tác',
      config: wfCongTac,
    },
  ];
  ...
  const subs = [
    ...
    {
      form: 'Đơn xin nghỉ phép',
      wf: 'Quy trình duyệt nghỉ phép',
      user: 'giangvien_duc',
      step: 'cho_truong_phong',
      status: SubmissionStatus.UNDER_REVIEW,
      data: {
        loaiNghi: 'phep_nam',
        ngayBatDau: '2026-06-16',
        soNgay: 3,
        lyDo: 'Về quê thăm gia đình nhân dịp hè',
        nguoiThayThe: 'ThS. Ngô Thanh Mai',
      },
    },
    // Nghỉ phép - đang chờ nhân sự (đã qua bước trưởng phòng)
    {
      ...
      data: {
        ...
        soNgay: 2,
        lyDo: 'Khám sức khỏe định kỳ tại Bệnh viện Bạch Mai',
        nguoiThayThe: 'TS. Hoàng Tiến Đức',
      },
    },
    // Nghỉ phép - đã duyệt
    {
      ...
      data: {
        ...
        soNgay: 1,
        lyDo: 'Tham dự lễ cưới em gái',
        nguoiThayThe: 'Đồng nghiệp phòng Đào tạo',
      },
    },
    // Nghỉ phép - bị từ chối
    {
      ...
      data: {
        loaiNghi: 'phep_nam',
        ngayBatDau: '2026-05-12',
        soNgay: 10,
        lyDo: 'Du lịch cùng gia đình',
        nguoiThayThe: 'Chưa sắp xếp',
      },
    },

    // Mua sắm - chờ duyệt song song
    {
      form: 'Đề xuất mua sắm thiết bị',
      wf: 'Quy trình duyệt mua sắm',
      user: 'giangvien_duc',
      step: 'cho_duyet',
      status: SubmissionStatus.UNDER_REVIEW,
      data: {
        tenThietBi: 'Máy chủ Dell PowerEdge R750',
        soLuong: 2,
        donGiaDuKien: 120000000,
        donViDeXuat: 'cntt',
        mucDich:
          'Phục vụ phòng Lab AI và Machine Learning cho sinh viên năm cuối',
        tinhCap: 'cap_bach',
      },
    },
    {
      ...
      status: SubmissionStatus.UNDER_REVIEW,
      data: {
        tenThietBi: 'Máy chiếu Epson EB-2250U',
        soLuong: 5,
        donGiaDuKien: 25000000,
        donViDeXuat: 'dt',
        mucDich: 'Thay thế máy chiếu phòng học tầng 3 nhà A2 đã hỏng',
        tinhCap: 'binh_thuong',
      },
    },
    // Mua sắm - đã duyệt
    {
      ...
      instanceStatus: WorkflowInstanceStatus.COMPLETED,
      data: {
        tenThietBi: 'Bộ kit thí nghiệm IoT Arduino',
        soLuong: 30,
        donGiaDuKien: 1500000,
        donViDeXuat: 'vt',
        mucDich: 'Trang bị phòng thí nghiệm IoT cho môn học Hệ thống nhúng',
        tinhCap: 'binh_thuong',
      },
    },
    ...
    {
      form: 'Đăng ký đề tài NCKH',
      wf: 'Quy trình xét duyệt đề tài NCKH',
      user: 'giangvien_duc',
      step: 'hoi_dong_xet_duyet',
      status: SubmissionStatus.UNDER_REVIEW,
      data: {
        tenDeTai: 'Ứng dụng Deep Learning trong phát hiện tấn công mạng IoT',
        linhVuc: 'attt',
        capDeTai: 'co_so',
        kinhPhi: 50,
        thoiGian: 12,
        tomTat:
          'Nghiên cứu và phát triển hệ thống phát hiện xâm nhập mạng IoT sử dụng mô hình Transformer, kết hợp kỹ thuật Federated Learning đảm bảo tính riêng tư dữ liệu',
      },
    },
    {
      form: 'Đăng ký đề tài NCKH',
      ...
      data: {
        tenDeTai:
          'Phân tích tác động của chuyển đổi số đến hiệu quả quản trị đại học',
        linhVuc: 'qtkd',
        capDeTai: 'cap_bo',
        kinhPhi: 150,
        thoiGian: 24,
        tomTat:
          'Đánh giá hiện trạng chuyển đổi số trong các trường đại học Việt Nam, xây dựng bộ tiêu chí đo lường và đề xuất mô hình quản trị đại học số phù hợp điều kiện Việt Nam',
      },
    },

    // Sự kiện - chờ duyệt
    {
      form: 'Đề xuất tổ chức sự kiện',
      wf: 'Quy trình duyệt sự kiện',
      user: 'giangvien_mai',
      step: 'cho_duyet',
      status: SubmissionStatus.UNDER_REVIEW,
      data: {
        tenSuKien: 'Hội thảo quốc gia về An toàn thông tin 2026',
        loaiSuKien: 'hoi_thao',
        ngayToChuc: '2026-09-15',
        soLuongThamGia: 200,
        kinhPhiDuKien: 50000000,
        moTa: 'Hội thảo quy tụ các chuyên gia ATTT trong nước, trình bày các nghiên cứu mới nhất về bảo mật AI và Zero Trust Architecture',
      },
    },
    // Sự kiện - đã duyệt
    {
      ...
      instanceStatus: WorkflowInstanceStatus.COMPLETED,
      data: {
        tenSuKien: 'Workshop: Cloud Computing với AWS',
        loaiSuKien: 'workshop',
        ngayToChuc: '2026-05-25',
        soLuongThamGia: 50,
        kinhPhiDuKien: 5000000,
        moTa: 'Workshop thực hành triển khai ứng dụng trên AWS cho sinh viên năm 3-4 khoa CNTT',
      },
    },

    // Công tác - chờ trưởng phòng
    {
      form: 'Đơn xin công tác',
      wf: 'Quy trình duyệt công tác',
      user: 'giangvien_duc',
      step: 'cho_truong_phong',
      status: SubmissionStatus.UNDER_REVIEW,
      data: {
        diaDiem: 'Đại học Bách khoa Hà Nội',
        mucDich: 'Tham dự Hội nghị quốc gia về CNTT lần thứ 25 (VNICT 2026)',
        ngayDi: '2026-07-10',
        ngayVe: '2026-07-12',
        phuongTien: 'tu_tuc',
        kinhPhi: 3000000,
    ...
    // Công tác - đang chờ tài chính
    {
      ...
      status: SubmissionStatus.UNDER_REVIEW,
      data: {
        diaDiem: 'TP. Hồ Chí Minh - Đại học Bách Khoa',
        mucDich: 'Báo cáo tại hội thảo IEEE RIVF 2026',
        ngayDi: '2026-08-05',
        ngayVe: '2026-08-08',
        phuongTien: 'may_bay',
        kinhPhi: 8500000,
  ...
  let createdSubs = 0;
  for (const s of subs) {
    const formId = formMap[s.form];
    const wfId = wfMap[s.wf];
    ...
    const instStatus =
      (s as any).instanceStatus ?? WorkflowInstanceStatus.ACTIVE;
    ...
    // History: submit
    const config = (
      await prisma.workflowDefinition.findUnique({ where: { id: wfId } })
    )?.config as any;
    ...
    if (s.step === 'cho_nhan_su') {
      await prisma.workflowHistory.create({
        data: {
          tenantId,
          instanceId: instance.id,
          fromStep: 'cho_truong_phong',
          toStep: 'cho_nhan_su',
          action: 'approve',
          actorId: userMap['truongphong_dt'],
          comment: 'Đồng ý, chuyển phòng TCNS xác nhận phép còn lại',
        },
      });
    }
    if (s.step === 'cho_tai_chinh') {
      await prisma.workflowHistory.create({
        data: {
          ...
          instanceId: instance.id,
          fromStep: 'cho_truong_phong',
          toStep: 'cho_tai_chinh',
          action: 'approve',
          actorId: userMap['truongphong_dt'],
          comment: 'Phù hợp kế hoạch nghiên cứu khoa',
        },
      });
    }
    if (s.step === 'hoi_dong_xet_duyet') {
      await prisma.workflowHistory.create({
        data: {
          ...
          instanceId: instance.id,
          fromStep: 'nop_ho_so',
          toStep: 'hoi_dong_xet_duyet',
          action: 'start_review',
          actorId: userMap['admin'],
          comment: 'Hồ sơ đạt yêu cầu, chuyển hội đồng xét duyệt',
        },
      });
    }
    if (s.step === 'da_duyet') {
    ...
    if (s.step === 'tu_choi') {
      await prisma.workflowHistory.create({
        data: {
          ...
          action: 'reject',
          actorId: userMap['truongphong_dt'],
          comment: 'Không thể sắp xếp người thay thế trong thời gian nghỉ dài',
        },
      });
    }
    createdSubs++;
  ...
  const delegations = [
    {
      ...
      formIds: [] as string[],
      wfIds: [] as string[],
      note: 'TP Đào tạo ủy quyền TP TCNS toàn bộ (đi công tác)',
    },
    {
      from: 'truongphong_tcns',
      to: 'nhansu_linh',
      formIds: [formMap['Đơn xin nghỉ phép']],
      wfIds: [],
      note: 'TP TCNS ủy quyền CV Nhân sự duyệt nghỉ phép',
    },
    {
      from: 'truongphong_khtc',
      to: 'nhansu_nam',
      formIds: [],
      wfIds: [wfMap['Quy trình duyệt mua sắm']],
      note: 'TP KHTC ủy quyền duyệt mua sắm',
    },
  ];
  ...
  for (const d of delegations) {
    await prisma.delegation.create({
      data: {
        tenantId,
        fromUserId: userMap[d.from],
        toUserId: userMap[d.to],
        startDate: now,
        endDate: in30d,
        isActive: true,
        formIds: d.formIds.filter(Boolean),
        workflowDefinitionIds: d.wfIds.filter(Boolean),
      },
    });
  ...
  const notifs = [
    {
      ...
      content:
        'ThS. Hoàng Tiến Đức (Khoa CNTT) đã nộp đơn xin nghỉ phép 3 ngày',
      type: 'INFO',
    },
    {
      user: 'nhansu_linh',
      title: 'Chờ xác nhận nghỉ phép',
      content:
        'Đơn nghỉ phép của ThS. Ngô Thanh Mai đã được Trưởng phòng duyệt, cần xác nhận',
      type: 'INFO',
    },
    {
      user: 'truongphong_dt',
      title: 'Đề tài NCKH chờ bỏ phiếu',
      content:
        'Đề tài "Ứng dụng Deep Learning..." cần hội đồng bỏ phiếu (2/3 đồng ý)',
      type: 'INFO',
    },
    {
      user: 'chuyenvien_tuan',
      title: 'Đơn nghỉ phép đã duyệt',
      content: 'Đơn xin nghỉ tham dự lễ cưới em gái đã được phê duyệt',
      type: 'SUCCESS',
    },
    {
      user: 'giangvien_an',
      ...
      content:
        'Đơn xin nghỉ 10 ngày du lịch bị từ chối: không sắp xếp được người thay thế',
      type: 'WARNING',
    },
    {
      user: 'truongphong_khtc',
      title: 'Đề xuất mua sắm cần duyệt',
      content:
        'Đề xuất mua 2 máy chủ Dell PowerEdge (240 triệu VNĐ) cần xét duyệt tài chính',
      type: 'INFO',
    },
  ];
